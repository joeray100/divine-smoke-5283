...
RSpec.describe 'Garden Show Page' do
  ...
  it "I don't see any duplicate plants or plants that take 100 days or more to harvest for that garden." do
    expect(current_path).to eq(garden_path(@garden1))
    ...
    expect(page).to_not have_content(@plant3.name, count: 1)
  end
end
